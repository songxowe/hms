 ...
 */
/*
 1，菜单按钮，原来不管有没有子菜单都会显示右边小按钮 现在只有当有子菜单时才显示右边小按钮 修改日期 2012-10-08 cl 
*/
(function($){
...
var btn=$(_354);
///以下七行为新增代码，只有当有字菜单时才显示右边向下按钮 2012-10-08 cl
if (opts.menu==null || opts.menu==undefined || opts.menu=="")
{
...
///下面为注释代码。如果要还原，则把上面七行代码删除，并把下面一行代码有效 2012-10-08 cl
///btn.linkbutton($.extend({},opts,{text:opts.text+"<span class=\"m-btn-downarrow\">&nbsp;</span>"}));
///btn.linkbutton($.extend({},opts,{text:opts.text+""}));
if(opts.menu){
