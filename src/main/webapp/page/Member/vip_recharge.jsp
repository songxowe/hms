...
<head>
    ...
    <script type="text/javascript" src="../Scripts/page/Member/vip_recharge.js"></script>
...
<div class="vip_infor" style="width: 800px">
    ...
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd; margin-top: 0px">
        <ul>
            ...
            <li>
                ...
                <span class="txt inps" id="MemberCardNo" style="width: 100px">&nbsp;</span></li>
            <li>
            ...
            <li>
                ...
                <span class="inps" id="Phone" style="width: 100px">&nbsp;</span></li>
            <li style="width: 100%">
                <label>喜好：</label>
    ...
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd;">
        <ul>
            <li>
                <label>支付方式：</label>
                <select style="width: 100px" class="txt" id="Paymethed"></select>
            </li>
            <li>
                <label>收款金额：</label>
                <input type="text" class="inps" style="width: 70px" id="PaymentAmount" maxlength="6" />
                <label style="margin-right: 5px">元</label></li>
            <li>
                <label style="width: 85px">充值金额：</label>
                <input type="text" class="inps" style="width: 75px" id="TopAmount" disabled="disabled" />
                <label style="margin-right: 5px">元</label>
            </li>
            <li>
                <label style="width: 85px">赠送积分：</label>
                <input type="text" class="inps" style="width: 90px" id="GiveScore" disabled="disabled" />
            </li>
            <li>
                <label style="width: 68px">销售员：</label>
                <select style="width: 100px" id="SalerId"></select>
            </li>
            <li>
                <label style="width: 92px">手工单号：</label>
                <input type="text" class="inps" id="ManualNumber" style="width: 90px"  maxlength="20" />
            </li>
            <li style="width:100%">
                <span style="color:red;width:100%;border:0px">注：如需退会员储值，可以在收款金额使用“负数”进行操作。</span>
            </li>
        </ul>
    </div>
    <!--end-->
    <div class="types">
        <ul style="float: right; width: 174px">
            <li style="">
                <input type="button" class="bus_add " value="会员充值" id="BtnSave" /></li>
