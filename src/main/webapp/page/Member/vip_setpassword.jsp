...
<head>
    ...
    <script type="text/javascript" src="../Scripts/page/Member/vip_setpassword.js"></script>
</head>
<body>
<div class="vip_infor" style="width: 800px">
    <div class="line">
        <div class="fl">密码重置</div>
    ...
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd;">
        <ul>
            <li>
                ...
                <input type="password" class="inps txt" style="width: 90px" id="NewPwd" maxlength="15" /></li>
            <li>
                <label style="width: 70px">确认密码：</label>
                <input type="password" class="inps" style="width: 90px" id="SavePwd" maxlength="15" /></li>
        </ul>
    </div>
    <!--end-->
    <div class="types">
        <ul style="float: right; width: 174px">
            <li style="">
                <input type="button" class="bus_add " value="密码重置" id="BtnSave" /></li>
