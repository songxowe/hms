...
<div class="vip_infor" style="width: 800px">
    ...
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd;">
        <ul>
            <li>
                <label style="width: 70px">调整积分：</label>
                <input type="text" class="inps" style="width: 90px" id="AdjustScore" maxlength="6" /><label style="width: 10px; padding-right: 24px">&nbsp;分</label></li>
            <li>
    ...
    <div class="types">
        <ul style="float: right; width: 174px">
            <li style="">
                <input type="button" class="bus_add " value="积分调整" id="BtnSave" /></li>
