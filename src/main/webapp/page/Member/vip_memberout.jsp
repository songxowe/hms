...
<head>
    ...
    <script type="text/javascript" src="../Scripts/page/Member/vip_memberout.js"></script>
</head>
<body>
<div class="vip_infor" style="width: 800px">
    ...
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd;">
        <ul>
            <li>
                <label>卡费金额：</label>
                <input type="text" class="txt inps" style="width: 90px" id="OutPrice"/>
            </li>
            <li>
                <label style="width: 60px">支付方式：</label>
                <select class="txt inps" style="width: 96px" id="Paymethed">
                </select>
            </li>
            <li>
            ...
            <li>
                <label>储值退款：</label>
                <input type="text" class="txt inps" style="width: 90px" id="OutPrice2"/>
            </li>
            <li>
                <label style="width: 60px">支付方式：</label>
                <select class="txt inps" style="width: 96px" id="Paymethed2">
                </select>
            </li>o
        </ul>
    </div>
    ...
    <div class="types">
        <ul style="float: right; width: 174px">
            <li style="">
                <input type="button" class="bus_add " value="会员退卡" id="BtnSave" /></li>
