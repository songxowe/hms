...
<head>
    ...
    <script type="text/javascript" src="../Scripts/page/Member/vip_memberoper.js"></script>
...
<div class="vip_infor" style="width: 800px">
    ...
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd;">
        <ul>
            <li>
                <label style="width: 70px">升级类型：</label>
                <input type="text" class="txt inps" style="width: 80px; color: #000" id="CategorgName" disabled="disabled" />
                <input type="hidden" class="inps" style="width: 90px" id="CategorgId" />
            </li>
            <li>
                <label style="width: 70px">扣减积分：</label>
                <input type="text" class="inps" style="width: 80px; color: #000" id="DeductScore" disabled="disabled" /></li>
        </ul>
    </div>
    <!--end-->
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd;">
        <ul>
            <li>
                <input type="checkbox" id="chkChargeCardFee" name="chkChargeCardFee"/>
                <label for="chkChargeCardFee"  style="padding-right: 20px" >收取卡费</label>
            </li>
            <li>
                <label style="width: 70px">支付方式：</label>
                <select style="width: 100px" id="PayMethod" disabled="disabled">
                </select>
            </li>
            <li>
                <label style="width: 70px">收款金额：</label>
                <input type="text" class="txt inps" style="width: 70px" id="Amount" maxlength="10" disabled="disabled"/>
            </li>
        </ul>
    </div>
    ...
    <div class="types">
        <ul style="float: right; width: 174px">
            <li style="">
                <input type="button" class="bus_add " value="会员升级" id="BtnSave" /></li>
