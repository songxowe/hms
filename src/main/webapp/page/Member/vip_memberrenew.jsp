...
<head>
    ...
    <script type="text/javascript" src="../Scripts/page/Member/vip_memberrenew.js"></script>
</head>
<body>
<div class="vip_infor" style="width: 800px">
    <div class="line">
        <div class="fl">会员续卡</div>
    ...
    <div class="types" style="background: #EFEFEF; border: 1px solid #ddd;">
        <ul>
            <li>
                ...
                <input type="text" class="inps" style="width: 34px" id="PeriodDay" />
                <label style="width: 60px; padding-right: 35px">天有效期</label></li>
            <li>
                <label style="width: 70px">支付方式：</label>
                <select class="txt" style="width: 90px;margin-right:35px;" id="Paymethed">
                </select>
            </li>
            <li>
                <label style="width: 70px">卡费：</label>
                <input type="text" class="inps" style="width: 90px" id="PeriodPrice" /></li>
        </ul>
    </div>
    <!--end-->
    ...
    <div class="types">
        <ul style="float: right; width: 174px">
            <li style="">
                <input type="button" class="bus_add " value="会员续卡" id="BtnSave" /></li>
